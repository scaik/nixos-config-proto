...
let
  hydeExtensions = pkgs.fetchzip {
    url = "https://github.com/HyDE-Project/HyDE/raw/aa49b3f2f18b54e775dd5389551569fe81ebd56a/Source/arcs/Firefox_Extensions.tar.gz";
    sha256 = "sha256-eeKzo6Ff/rXTlau5F4LSrM+Bfl+mhgR42B19dzmacJc=";
  };
  hydeConfig = pkgs.fetchzip {
    url = "https://github.com/HyDE-Project/HyDE/raw/aa49b3f2f18b54e775dd5389551569fe81ebd56a/Source/arcs/Firefox_UserConfig.tar.gz";
